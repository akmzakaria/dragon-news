  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="w-full md:w-11/12 mx-auto my-2 md:my-3 px-3 md:px-0 grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-5">
        {/* Left Sidebar - Mobile: Horizontal scroll, Desktop: Sticky sidebar */}
        <aside className="md:col-span-3 md:sticky md:overflow-y-auto md:self-start md:top-0 md:h-screen custom-scrollbar">
